#!/usr/bin/env node
// scripts/seed_100_users_posts.js
// Fetch 100 fake users from randomuser.me and generate a SQL migration that:
// - Inserts each user (idempotent)
// - Inserts a profile with a profile_photo URL (do not store the binary, only the URL)
// - Inserts a single post for each user with randomized words
